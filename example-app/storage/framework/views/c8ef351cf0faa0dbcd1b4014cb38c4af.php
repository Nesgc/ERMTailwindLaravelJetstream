...
} elseif ($_instance->childHasBeenRendered('l3374205218-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3374205218-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3374205218-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3374205218-0');
} else {
    $response = \Livewire\Livewire::mount('create-post');
    $html = $response->html();
    $_instance->logRenderedChild('l3374205218-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
        ...
        <table class="w-full border-collapse  bg-white text-left text-base text-gray-500">
          ...
          <tbody class="divide-y divide-gray-100 border-t border-gray-100">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 text-base"><?php echo $item->content; ?></td>
...
<?php /**PATH C:\xampp\htdocs\lara1\example-app\resources\views/livewire/show-unidades.blade.php ENDPATH**/ ?>